...
# lista_usuarios = ['Amanda', 'Carolina', 'João', 'Letícia', 'Yasmin']
...
def salvar_imagem(imagem):
    # adicionar código aleatório ao nome da imagem e determinar o caminho completo para o arquivo
    ...
    # mudar o campo foto_perfil do usuário para o novo nome da imagem (salvar a imagem)
...
def atualizar_cursos(form):
    ...
    for campo in form:
        if 'curso_' in campo.name:
            # adicionar o texto do campo.label (Excel) na lista de cursos
            if campo.data:
